			...
			<div class="box">
				<div class="col-lg-12">
					<h4 class="title">Flight numbers and weekdays of all flight
						(Use Case 1 - Part 2)</h4>

					<form id="form1" method="post" action="UseCase1_2"
						...
						<div class="form-group">
							<label for="datebox_flight_date" class="col-sm-3 control-label">Flight
								Date : </label>
							<div class="col-sm-3">
								<input class="form-control" id="datebox_flight_date" type="date"
									name="datebox_flight_date" value="" placeholder="Flight Date"
									min="2014-01-01" max="2020-12-31" required="true">
							</div>
						</div>
